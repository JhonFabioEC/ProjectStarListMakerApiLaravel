...
class PersonProfileUserController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('user_profile')->with(['success' => 'usuario actualizado']);
        } else {
            return redirect()->route('user_edit_profile')->withErrors(['error' => 'no se pudo actualizar el usuario']);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($response->successful()) {
            ...
            return redirect()->route('user_edit_profile')->withErrors(['error' => 'el usuario no puede ser eliminado']);
        }
    }
}
