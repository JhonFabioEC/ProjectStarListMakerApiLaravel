            ...
            <form action="{{ route('updateEstablishment') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-3 d-flex justify-content-center">
                        ...
                        src="@isset($establishment)
                            {{ asset('storage/users/establishments/' . $establishment['user']['image']) }}
                        @else
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="form-control custom-file-input" name="image" id="customFile"
                                ...
                                @isset($establishment)
                                    value="{{ old('image', $establishment['user']['image']) }}"
                                @endisset>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 form-outline mb-3">
                        <div class="form-group">
                            ...
                            <p class="form-control w-100 bg-body-secondary">{{ $establishment['user']['username'] }}</p>
                        </div>
                    </div>
                        ...
                        <div class="form-outline">
                            <div class="form-group text-right">
                                <div class="btns-group">
                                    ...
                                    <button type="button"
                                        onclick="window.location.href = '/establishment/profile/delete/{{ $establishment['user']['id'] }}';"
